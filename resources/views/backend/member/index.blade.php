                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($members as $key=>$list )
                                        <tr>
                                            <td>{{ $list->id }}</td>
                                            <td><a href="{{ route('member.show', $list->id) }}">{{ $list->name }}</td>
                                            <td>{{ $list->gender }}</td>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="{{ route('member.show', $list->id) }}" class="btn btn-sm bg-primary-light mr-2">
                                                        <i class="far fa-eye me-2"></i>
                                                    </a>
                                                    <a href="{{ route('member.edit', $list->id) }}" class="btn btn-sm bg-primary-light">
