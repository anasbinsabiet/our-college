                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="page-sub-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <a class="breadcrumb-item active">Syllabus Details</a>
                ...
                <div class="col-lg-10 col-md-12 mx-auto">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p class="mb-0">{{ $syllabus->title ?? '—' }}</p>
                                </div>

                                {{-- Department --}}
                                <div class="col-md-4">
                                    <label class="fw-semibold text-muted">Department</label>
                                    <p class="mb-0">{{ $syllabus->department ?? '—' }}</p>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if(!empty($syllabus->file))
                                        <a href="{{ asset('uploads/syllabuss/' . $syllabus->file) }}"
                                        download
                        ...
                        <div class="card-footer text-end bg-white">
                            <a href="{{ route('syllabus.index') }}" class="btn btn-sm btn-outline-secondary">
                                Back
                            </a>
                        </div>
                    </div>
