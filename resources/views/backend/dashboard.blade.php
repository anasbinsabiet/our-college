        ...
        <div class="content container-fluid">
            ...
            @if(auth()->user()->role_name == 'Accountant')
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        ...
                                        <h3>{{ number_format($collections ?? 0) }}</h3>
                                    </div>
                                    <div class="db-icon">
                    ...
                    <a class="col-xl-3 col-sm-6 col-6 d-flex" href="#">
                        <div class="card bg-common w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Today’s Collection</h6>
                                        <h3>{{ number_format($todayCollections ?? 0) }}</h3>
                                    </div>
                                    <div class="db-icon">
                    ...
                    <a class="col-xl-3 col-sm-6 col-6 d-flex" href="#">
                        <div class="card bg-common w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>This Week's Collections</h6>
                                        <h3>{{ number_format($thisWeekCollections ?? 0) }}</h3>
                                    </div>
                                    <div class="db-icon">
                    ...
                    <a class="col-xl-3 col-sm-6 col-6 d-flex" href="#">
                        <div class="card bg-common w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>This Month's Collections</h6>
                                        <h3>{{ number_format($thisMonthCollections ?? 0) }}</h3>
                                    </div>
                                    <div class="db-icon">
