                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control @error('phone') is-invalid @enderror" type="number" name="phone" placeholder="Enter Phone Number" value="{{ optional($teacher)->phone }}">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group local-forms calendar-icon">
                                            ...
                                            <input class="form-control datetimepicker @error('joining_date') is-invalid @enderror" name="joining_date" type="text" placeholder="DD-MM-YYYY" value="{{ optional($teacher)->joining_date }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group local-forms calendar-icon">
                                            <label>Leaving Date</label>
                                            <input class="form-control datetimepicker @error('leaving_date') is-invalid @enderror" name="leaving_date" type="text" placeholder="DD-MM-YYYY" value="{{ optional($teacher)->leaving_date }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group local-forms">
                                    ...
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('status') is-invalid @enderror" name="status">
                                                <option selected disabled>Select Status </option>
                                                <option value="Active" {{ optional($teacher)->status == 'Active' ? "selected" :""}}>Active</option>
                                                <option value="Inactive" {{ optional($teacher)->status == 'Inactive' ? "selected" :""}}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-3">
